...
def parse_instances(xml_list):
    ...
    for inst in xml_list:
        ...
        elif objname == "obj_mode_s":
            rooms[rx][ry].append([29, ra_x, ra_y])
        elif objname == "obj_hunter_s":
            rooms[rx][ry].append([30, ra_x, ra_y])
        elif objname == "obj_eidolon_s":
            rooms[rx][ry].append([31, ra_x, ra_y])
        elif objname == "obj_chainsnake_s":
            rooms[rx][ry].append([32, ra_x, ra_y])
        elif objname == "obj_direviper_s":
            rooms[rx][ry].append([33, ra_x, ra_y])
        elif objname == "obj_annihilator_s":
        ...
        elif objname == "obj_smasher_s":
            rooms[rx][ry].append([37, ra_x, ra_y])
        elif objname == "obj_elite_s":
            rooms[rx][ry].append([38, ra_x, ra_y])
        elif objname == "obj_guardian_s":
            rooms[rx][ry].append([39, ra_x, ra_y])
        elif objname == "obj_guardianspecial2":
            rooms[rx][ry].append([40, ra_x, ra_y])
        elif objname == "obj_guardianspecial":
            rooms[rx][ry].append([41, ra_x, ra_y])
        elif objname == "obj_processor_s":
            rooms[rx][ry].append([42, ra_x, ra_y])
        elif objname == "obj_holder":
            rooms[rx][ry].append([43, ra_x, ra_y])
        elif objname == "obj_eyespy_s":
        ...
        elif objname == "obj_ship":
            rooms[rx][ry].append([47, ra_x, ra_y])
        elif objname == "obj_dread_s":
            rooms[rx][ry].append([48, ra_x, ra_y])
